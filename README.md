...
## 🚀 Getting Started with NeuroForm
...
## 💻 Installing NeuroForm on Windows

Follow these steps to install NeuroForm:

1. Click the `.exe` installer file you downloaded.
2. You may see a security warning; click **Run** to continue.
3. A setup window will appear. Click **Next** to start.
4. Read the license agreement, then click **I Agree** to proceed.
5. Choose the folder where you want to install NeuroForm. The default path works for most users.
